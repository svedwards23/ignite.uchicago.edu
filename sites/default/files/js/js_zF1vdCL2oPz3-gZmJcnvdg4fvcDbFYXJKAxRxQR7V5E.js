...
$.Autocompleter = function(input, options) {
	...
	function request(term, success, failure) {
		...
		// if an AJAX url has been supplied, try loading the data now
			...
			// nexusipe 20150312 >>>
			// send the form ID with the request
			extraParams.form_id = jQuery(input.form).attr('id');

			// send the current URL with the request
			extraParams.page_url = window.location.pathname;
